...
def export_csv(instances, path):
    ...
    headers = [
        ...
        "Risk: Too New",
        "Risk: Score Decrease",
        "Risk: Provenance Regression",
        "Risk: Registry Signature Regression",
        "Risk: Any Risks",
        ...
        "supply_chain_previous_trust_score",
        "supply_chain_trust_score_delta",
        "provenance_present",
        "previous_provenance_present",
        "provenance_regressed",
        "registry_signature_present",
        "previous_registry_signature_present",
    ...
    for x in instances:
        ...
        row = [
            ...
            x.risk_min_versions,
            x.risk_too_new,
            _nv(getattr(x, "risk_score_decrease", None)),
            _nv(getattr(x, "risk_provenance_regression", None)),
            _nv(getattr(x, "risk_registry_signature_regression", None)),
            x.has_risk(),
            ...
            _nv(getattr(x, "release_age_days", None)),
            _nv(getattr(x, "trust_score", None)),
            _nv(getattr(x, "previous_trust_score", None)),
            _nv(getattr(x, "trust_score_delta", None)),
            _nv(getattr(x, "provenance_present", None)),
            _nv(getattr(x, "previous_provenance_present", None)),
            _nv(getattr(x, "provenance_regressed", None)),
            _nv(getattr(x, "registry_signature_present", None)),
            _nv(getattr(x, "previous_registry_signature_present", None)),
            _nv(getattr(x, "registry_signature_regressed", None)),
            _nv(getattr(x, "checksums_present", None)),
            _nv(getattr(x, "previous_checksums_present", None)),
            _nv(getattr(x, "previous_release_version", None)),
...
def export_json(instances, path):
    ...
    for x in instances:
        entry = {
            ...
            "supply_chain_previous_trust_score": getattr(x, "previous_trust_score", None),
            "supply_chain_trust_score_delta": getattr(x, "trust_score_delta", None),
            "supply_chain_trust_score_decreased": getattr(x, "trust_score_decreased", None),
            "provenance_present": getattr(x, "provenance_present", None),
            "previous_provenance_present": getattr(x, "previous_provenance_present", None),
            "provenance_regressed": getattr(x, "provenance_regressed", None),
            "registry_signature_present": getattr(x, "registry_signature_present", None),
            "previous_registry_signature_present": getattr(x, "previous_registry_signature_present", None),
            "registry_signature_regressed": getattr(x, "registry_signature_regressed", None),
            "checksums_present": getattr(x, "checksums_present", None),
            "previous_checksums_present": getattr(x, "previous_checksums_present", None),
            "previous_release_version": getattr(x, "previous_release_version", None),
            "risk": {
                "hasRisk": x.has_risk(),
                ...
                "scoreDecreased": getattr(x, "risk_score_decrease", None),
                "provenanceRegressed": getattr(x, "risk_provenance_regression", None),
                "registrySignatureRegressed": getattr(x, "risk_registry_signature_regression", None),
            },
